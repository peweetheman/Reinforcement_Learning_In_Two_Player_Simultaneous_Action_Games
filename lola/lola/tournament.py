...
from lola.lola.baselines import *
from lola.lola.exact import *
from lola.lola.utils import *

import lola.lola.logger as logger
AGENTS= {
    'BRAT': BRAT,
...
def train(env, *, num_episodes=1000, trace_length=10, lr=0.01, gamma=1.0, seed=42):
    agent_names = ['BRAT', 'JAL-Q', 'META-NASH', 'WoLF', 'NL-PG', 'LOLA']
